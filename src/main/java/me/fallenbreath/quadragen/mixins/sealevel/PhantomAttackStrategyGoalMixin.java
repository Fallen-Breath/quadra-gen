...
public abstract class PhantomAttackStrategyGoalMixin
{
	...
	private int useSeaLevelAtTarget(int original)
	{
		...
		//#else
		//$$ LivingEntity target = this.field_7321.getTarget();
		//$$ return target == null ? original : SeaLevelQuery.getSeaLevelAt(this.field_7321.level(), target.blockPosition(), original);
		//#endif
	}
}

...
2. To customize the layout of dimensions or quadrants, prepare or edit `config/quadragen/config.json` before creating the world. If the config file does not exist, Quadra Gen copies the bundled [default configuration](src/main/resources/default_config.json) into place and enables it.
